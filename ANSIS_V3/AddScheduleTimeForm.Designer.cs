namespace ANSIS_V3
{
    partial class AddScheduleTimeForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.dgvSchedTime.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
			...
			this.dgvSchedTime.DefaultCellStyle = dataGridViewCellStyle5;
			...
			this.dgvSchedTime.RowHeadersDefaultCellStyle = dataGridViewCellStyle6;
